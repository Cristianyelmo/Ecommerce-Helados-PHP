...
<section class="flex justify-center ">
    ...
    <h2>Correo</h2>
<input type="email" id="campo-texto" class="border-2 shadow-custom border-black bg-transparent p-2 w-full">
<h2>username</h2>
...
<button class="bg-[#E97C8D] px-4 py-2 border border-2 border-black rounded-[40.5px] text-center ">Registrar</button>
</div>
